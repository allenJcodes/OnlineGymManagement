...
@section('content')
    <div class="flex flex-col pt-14 gap-5 text-background">
        <h1 class="text-2xl font-bold">Add Gym Session Content</h1>

        <form action="{{route('contents.gym_session.store')}}" method="POST" class="flex flex-col gap-3 card">
            @csrf
            ...
            <div class="self-end flex gap-2">
                ...
                <button class="primary-button">Add Gym Session Content</button>
            </div>
        </form>
