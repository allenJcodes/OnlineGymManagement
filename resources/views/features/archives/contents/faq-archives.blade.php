...
@section('content')
    ...
    {{-- @dd(session('toast')) --}}
        <div class="flex items-start w-full justify-between">
            <h1 class="text-2xl font-bold">FAQ Archives</h1>
        </div>
        ...
        <div class="flex flex-col gap-2">
            ...
            <div class="card">
                <div class="flex w-full justify-between">
                    <h2 class="text-xl font-medium">FAQ Archives List</h2>
                    {{-- form actions here --}}
                                        ...
                                        <div class="flex flex-col gap-2 divide-y divide-light-gray-background">
                                            ...
                                            <div class="flex flex-col divide-y divide-light-gray-background" aria-labelledby="dropdownButton">
                                                <button data-modal-target="popup-modal" data-modal-toggle="popup-modal"
                                                    ...
                                                    data-url="{{ route('archive.faq.restore', ['faq' => $faq]) }}">
                                                    Restore
                                                </button>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        restoreButtons.forEach(button => {
            ...
            button.addEventListener('click', () => {
                modalText.innerText = "Are you sure you want to restore FAQ \"" + faq.title + "\" ?";
