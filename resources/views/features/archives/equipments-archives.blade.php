...
@section('content')
    <div class="flex flex-col pt-16 gap-5 text-background">
        ...
        <div class="flex items-start w-full justify-between ">
            <h1 class="text-2xl font-bold">Equipments Archives</h1>
        </div>

        <div class="card">
            <h2 class="text-xl font-medium">Equipment Archives List</h2>
                                    ...
                                    <div class="flex flex-col gap-2 divide-y divide-light-gray-background">
                                        ...
                                        <div class="flex flex-col divide-y divide-light-gray-background" aria-labelledby="dropdownButton">
                                            <button data-modal-target="popup-modal" data-modal-toggle="popup-modal"
                                                ...
                                                data-url="{{ route('archive.equipments.restore', ['equipment' => $equipment]) }}">
                                                Restore
                                            </button>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        restoreButtons.forEach(button => {
            ...
            button.addEventListener('click', () => {
                modalText.innerText = "Are you sure you want to restore equipment \"" + equipment.equipment_name + "\" ?";
