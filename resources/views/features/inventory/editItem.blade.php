        ...
        <div
            ...
            <form action="{{ route('updateItem', $item->id) }}" method="POST">
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input value="{{ $item->item_name }}" type="text" name="item_name" id="floating_email"
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input value="{{ $item->quantity }}" type="text" name="quantity" id="floating_password"
                        class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                        placeholder=" " required />
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-6 group">
                        <input value="{{ $item->equipment_type }}" type="text" name="equipment_type"
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input value="{{ $item->purchase_date }}" type="text" name="purchase_date"
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-6 group">
                        <input value="{{ $item->warranty_information }}" type="text" name="warranty_information"
                            id="floating_first_name"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " required />
                        <label for="floating_first_name"
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input value="{{ $item->maintenance_history }}" type="text" name="maintenance_history"
                            id="floating_last_name"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " required />
                        <label for="floating_last_name"
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input value="{{ $item->status }}" type="text" name="status" id="floating_last_name"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " required />
                        <label for="floating_last_name"
