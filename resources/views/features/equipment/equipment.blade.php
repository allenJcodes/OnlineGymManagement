        ...
        @if (Auth::user()->user_role == 1 || Auth::user()->user_role == 2)
            <div class="flex justify-end pr-4">
                ...
                <a href="{{ route('equipment_types.index') }}">
                    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Manage
                        Equipment Types
                    </button>
                </a>
            </div>
                ...
                <div class="col-span-1 pb-2 ml-2 mr-2">
                    <div
                        ...
                        @if (Auth::user()->user_role == 1)
                            <div class="px-4  ">
                                <div class="pt-2"style="z-index: 1;  float: right; postion: absolute">
                                    <button id="dropdownButton" data-dropdown-toggle="toggle{{ $equipment->id }}"
                        ...
                        <div href="{{route('equipment.edit', ['equipment' => $equipment])}}" class="MT-3">
                            ...
                            @elseif ($equipment->status == 'not_available')
                                <span
                            ...
                            <div class="flex justify-center items-center pt-8 pl-12">
                                ...
                                <img src="{{ asset('image/equipment/' . $equipment->image_path) }}" class="h-36 justify-center"
                                    alt="" />
                            </div>
                        ...
                        {{-- <span class="text-red-500 p-2">
                            ...
                            <button id="delete{{ $equipment->id }}" type="button"
