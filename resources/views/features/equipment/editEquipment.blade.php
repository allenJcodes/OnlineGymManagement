            ...
            <form enctype="multipart/form-data" action="{{ route('updateEquipment', $equipment->id) }}" method="POST">
                ...
                <div class="pb-5">
                    ...
                    <select id="equipment_type" name="equipment_type_id"
                        ...
                        <option value="" @if (!$equipment->equipment_type_id) selected="selected" @endif disabled>Select
                ...
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="multiple_files">Replace
                    Image</label>
                <input
