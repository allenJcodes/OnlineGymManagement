...
<body class="font-red-hat-display">
    <div id="app">
        <header class="antialiased">
            <nav class="bg-slate-900 border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800 fixed w-full z-20 top-0 left-0">
                                ...
                                <a href="#"
                                    ...
                                    <div class="pl-3 w-full">
                                        <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400"><span
                                                ...
                                                class="font-medium text-gray-900 dark:text-white">141 others</span>
